package com.livemilton.loans.controller;
...
import com.livemilton.loans.dto.ErrorResponseDto;
import com.livemilton.loans.dto.LoansContactInfoDto;
import com.livemilton.loans.dto.LoansDto;
import com.livemilton.loans.dto.ResponseDto;
...
@Tag(name = "CRUD REST APIs for Loans in livemilton Bank", description = "CRUD REST APIs in livemiltonBank to CREATE, UPDATE, FETCH AND DELETE loans details")
@RestController
...
public class LoansController {
        ...
        @Operation(summary = "Create Loan REST API", description = "REST API to create new loans inside livemilton Bank")
        @ApiResponses({
